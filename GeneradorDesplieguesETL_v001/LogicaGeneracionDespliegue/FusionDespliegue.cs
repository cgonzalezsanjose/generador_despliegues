...
namespace LogicaGeneracionDespliegue
{
	...
	public class FusionDespliegue
	{
		...
		public FusionDespliegue(string nombreFicheroOrden, string rutaScripts, string rutaDestino, string regexValidacion, string regexReemplazo)
		{
